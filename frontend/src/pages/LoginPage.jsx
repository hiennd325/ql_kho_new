      ...
      >
        <div className={`backdrop-blur-xl border rounded-[2.5rem] shadow-2xl p-10 overflow-hidden relative group transition-colors duration-300 ${isDarkMode ? 'bg-white/[0.03] border-white/10' : 'bg-white border-slate-200'}`}>
          ...
          <div className="text-center mb-10">
            ...
            <h1 className={`text-3xl font-black tracking-tighter mb-2 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>QUẢN LÝ KHO</h1>
            <p className={`${isDarkMode ? 'text-gray-400' : 'text-slate-500'} font-medium`}>Hệ thống vận hành thông minh</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full border rounded-2xl pl-12 pr-4 py-4 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 outline-none transition-all font-medium placeholder:text-gray-600 ${isDarkMode ? 'bg-white/[0.05] border-white/10 text-white focus:bg-white/[0.08]' : 'bg-slate-50 border-slate-200 text-slate-900 focus:bg-white'}`}
